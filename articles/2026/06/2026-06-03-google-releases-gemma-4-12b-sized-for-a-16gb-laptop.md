...
Google's ~12B-parameter Gemma 4 under Apache 2.0 is engineered for 16GB consumer hardware. An encoder-free unified architecture feeds raw audio and visual patches directly into the language backbone, natively handling text, image, audio, and video. A push toward on-device AI as memory costs climb.
