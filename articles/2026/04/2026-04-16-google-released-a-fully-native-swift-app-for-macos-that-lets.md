---
article_id: 2026-04-16-google-released-a-fully-native-swift-app-for-macos-that-lets
title: Google released a fully-native Swift app for macOS that lets users share their
  screen or local files with Gemini in…
date: '2026-04-16'
...
normalized_title_hash: 964ca67d0c31368d
canonical_url_hash: ''
tags: []
entities:
- Apple
...
# Google released a fully-native Swift app for macOS that lets users share their screen or local files with Gemini in…

Google released a fully-native Swift app for macOS that lets users share their screen or local files with Gemini in real time. Over 100 features built in 100 days, per Google VP Josh Woodward. Free with a Google account. Separately, Google's Gemma 4 now runs natively on iPhone with full offline AI inference.
