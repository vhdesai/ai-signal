---
article_id: 2026-09-18-world-model-startups-stay-secretive-about-commercialization
title: World-Model Startups Stay Secretive About Commercialization
date: '2026-09-18'
source: TechCrunch
...
normalized_title_hash: 68a354c5471cbb07
...
# World-Model Startups Stay Secretive About Commercialization

Reporting from the All In conference found that leading world-model labs — Yann LeCun's AMI Labs and Fei-Fei Li's World Labs — decline to discuss product plans or timelines despite heavy funding. AMI's VP of World Models offered only “we'll talk about it when we're ready,” and even data supplier Physicl says it does not know what its customers are building. World Labs' Marble remains the most developed product in the category. For buyers, the category still has no evaluable roadmap.
