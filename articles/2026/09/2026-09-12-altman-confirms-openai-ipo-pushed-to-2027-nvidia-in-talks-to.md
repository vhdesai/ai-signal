---
article_id: 2026-09-12-altman-confirms-openai-ipo-pushed-to-2027-nvidia-in-talks-to
title: Altman confirms OpenAI IPO pushed to 2027; Nvidia in talks to invest up to
  $10B in Anthropic's $2T IPO
date: '2026-09-12'
...
normalized_title_hash: 9651f5fe28eef6dc
canonical_url_hash: adaebe0c9002dee8
tags:
- Breaking
entities:
- Anthropic
...
Sam Altman told a TechCrunch audience it would be "ill-advised" to take OpenAI public in 2026, effectively confirming a 2027 IPO window that he ties partly to safety concerns. Separately, The Decoder (citing Reuters) reports that Nvidia is in talks to invest up to $10B in Anthropic's planned IPO, which would target a roughly $2T valuation — the largest IPO in history, and one where most of the primary proceeds will likely flow back to Nvidia as chip orders. Together, these signal that both frontier labs are extending private-market runway while public-market entry gets more expensive to underwrite.
