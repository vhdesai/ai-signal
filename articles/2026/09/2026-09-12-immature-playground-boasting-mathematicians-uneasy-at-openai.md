---
article_id: 2026-09-12-immature-playground-boasting-mathematicians-uneasy-at-openai
title: '“Immature playground boasting”: mathematicians uneasy at OpenAI''s Navier–Stokes
  claim'
date: '2026-09-12'
source: The Guardian
...
normalized_title_hash: 11bbd77dbe3b9f62
canonical_url_hash: 2c907c24c20ab57c
tags:
- Trending
entities:
- OpenAI
...
# “Immature playground boasting”: mathematicians uneasy at OpenAI's Navier–Stokes claim

Coverage of the academic backlash to OpenAI's claim that a 10,000-agent swarm resolved a Millennium Prize–class Navier–Stokes problem, with researchers reporting shock at the pace of change alongside discomfort at the framing. The dispute centres on attribution and on whether the system benefited from a researcher's private Codex data. The governing lesson is contractual rather than mathematical: when AI systems generate valuable IP, data-retention and training-access terms become part of the technical architecture, not boilerplate.
