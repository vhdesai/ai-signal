---
article_id: 2026-08-25-ibm-releases-granite-4-2-bringing-native-reasoning-and-agent
...
normalized_title_hash: d364c9edd1e77590
canonical_url_hash: 4cfd2750e2cfd784
tags: []
entities:
- IBM
- OpenAI
...
embedding_id: 2026-08-25-ibm-releases-granite-4-2-bringing-native-reasoning-and-agent
event_name: ''
---

# IBM releases Granite 4.2, bringing native reasoning and agentic RL to open enterprise models

IBM published Granite 4.2 as dense reasoning models in 3B, 8B, and 30B sizes under Apache 2.0, with switchable "thinking," agentic reinforcement learning, and OpenAI-format tool calling. The sizing is deliberate: these are models meant to be self-hosted for agentic workloads rather than to contest frontier benchmarks. For regulated enterprises, permissive licensing plus local deployability is the operative feature, not raw capability.
...
**Related:** [[2026-08-26-ibm-launches-granite-4-2-open-weight-models-for-local-and-ag]] · [[2026-08-25-ibm-releases-granite-4-2-open-weight-reasoning-models-3b-8b]] · [[2026-04-29-ibm-granite-4-1-series-released-open-source-enterprise-model]] · [[2026-04-27-openai-released-a-public-specification-for-orchestrating-cod]] · [[2026-05-14-ibm-launches-red-hat-ai-inference-server-and-openshift-ai-vi]]
<!-- graph:end -->
