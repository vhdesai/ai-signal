---
article_id: 2026-08-03-7-knowbe4-extends-agent-risk-manager-to-anthropic-s-claude
title: 7. KnowBe4 extends Agent Risk Manager to Anthropic’s Claude
date: '2026-08-03'
...
normalized_title_hash: 17a50767ec00d4fe
canonical_url_hash: 9cc5696e6ce7f6a6
tags: []
entities:
- Anthropic
themes:
...
# 7. KnowBe4 extends Agent Risk Manager to Anthropic’s Claude

Announced at Black Hat, KnowBe4’s agent-governance layer — previously Copilot-native — now covers Claude-based agents. The expansion reflects rapid demand for security and oversight tooling as autonomous agents move into production. (Vendor announcement.) NewAI Infrastructure
